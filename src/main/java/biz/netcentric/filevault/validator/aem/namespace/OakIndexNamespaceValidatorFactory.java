...
public class OakIndexNamespaceValidatorFactory extends AbstractPatternSettingsValidatorFactory {

    public OakIndexNamespaceValidatorFactory() {
        super("netcentric-oakindex-namespace", "allowedPathPatterns", false);
    }

    @Override
    protected Validator createValidator(
            @NotNull Set<Pattern> patterns, @NotNull ValidationContext context, @NotNull ValidatorSettings settings) {
        return new OakIndexNamespaceValidator(settings.getDefaultSeverity(), patterns);
    }
}
