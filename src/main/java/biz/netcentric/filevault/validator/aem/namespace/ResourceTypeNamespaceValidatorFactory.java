...
public class ResourceTypeNamespaceValidatorFactory extends AbstractPatternSettingsValidatorFactory {

    public ResourceTypeNamespaceValidatorFactory() {
        super("netcentric-resourcetype-namespace", "allowedTypePatterns", true);
    }
    ...
    protected Validator createValidator(
        ...
        Set<Pattern> allowedSuperTypePatterns =
                createPatternsFromCommaSeparatedString(settings.getOptions().get("allowedSuperTypePatterns"));
        return new ResourceTypeNamespaceValidator(settings.getDefaultSeverity(), patterns, allowedSuperTypePatterns);
    }
}
