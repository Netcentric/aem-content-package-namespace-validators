...
public class FilterNamespaceValidatorFactory extends AbstractPatternSettingsValidatorFactory {

    public FilterNamespaceValidatorFactory() {
        super("netcentric-filter-namespace", "allowedFilterRootPatterns", false);
    }
    ...
    public @Nullable Validator createValidator(
        ...
        return new FilterNamespaceValidator(settings.getDefaultSeverity(), patterns);
    }
}
